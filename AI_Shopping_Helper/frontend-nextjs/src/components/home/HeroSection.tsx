          ...
          >
            <div className="glass-card p-8 rounded-3xl">
              ...
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 flex items-center justify-center relative overflow-hidden">
                ...
                {/* Main cosmic glow - ONE single elegant halo */}
                <motion.div
                  animate={{
                    scale: [1, 1.2, 1],
                    opacity: [0.5, 0.7, 0.5],
                ...
                {/* Subtle nebula swirl - minimal and non-distracting */}
                <motion.div
                  animate={{
                    rotate: 360,
                  }}
                ...
                {/* Fine starlight particles - realistic cosmic dust */}
                {[...Array(25)].map((_, i) => (
                  <motion.div
                    key={i}
                    ...
                    style={{
                      ...
                      background: i % 3 === 0 ? 'rgba(255, 255, 255, 0.6)' : i % 3 === 1 ? 'rgba(168, 85, 247, 0.5)' : 'rgba(236, 72, 153, 0.5)',
                    }}
                    animate={{
                      opacity: [0.2, 0.9, 0.2],
                      scale: [0.8, 1.3, 0.8],
                ...
                {/* Minimal orbital rings - subtle galaxy rings */}
                <motion.div
                  className="absolute w-[300px] h-[300px] rounded-full border border-purple-400/8"
                  animate={{ rotate: 360 }}
                  transition={{ duration: 60, repeat: Infinity, ease: "linear" }}
                />
                <motion.div
                  className="absolute w-[340px] h-[340px] rounded-full border border-indigo-400/6"
                  animate={{ rotate: -360 }}
                ...
                >
                  <div className="relative w-32 h-32 lg:w-32 lg:h-32 md:w-28 md:h-28 sm:w-24 sm:h-24">
                    ...
                    {/* Soft light aura around AI - enhanced glow */}
                    <motion.div
                      ...
                      <motion.div 
                        ...
                        animate={{ 
                          textShadow: [
                            ...
                            "0 3px 12px rgba(0,0,0,0.6), 0 0 50px rgba(59, 130, 246, 1.2)",
                          ]
                        }}
                    ...
                    {/* Micro star particles around orb */}
                    {[...Array(8)].map((_, i) => (
                      <motion.div
                        key={i}
